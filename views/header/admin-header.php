<div class="main-header-container">
    ...
    ?>
    <div class="tabs">
        <li><a href="<?php echo esc_url(admin_url("admin.php?page=wpbm-backup-migration")) ?>" class="<?php echo $active_page === 'wpbm-backup-migration' ? 'active' : '' ?>">Backup & Migration</a></li>
